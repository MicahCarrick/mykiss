...
class Document(GObject.Object, LogObject):
    ...
    __gsignals__ = {
        ...
        "info-changed":   (GObject.SIGNAL_RUN_FIRST, GObject.TYPE_NONE, 
                          (GObject.TYPE_PYOBJECT,)),
        "foobar":   (GObject.SIGNAL_RUN_FIRST, GObject.TYPE_NONE, 
                          (GObject.TYPE_PYOBJECT,)),
    }
    ...
    def _query_info(self):
        ...
        self.debug('"info-changed" %s Mime: %s, Language: %s, Icon: %s', 
                   self._name, self._mime_type, self.get_language_name(),
                   self._icon_name)
        self.emit("info-changed", info)
