...
class Editor(Gtk.Paned):
    ...
    def new_tab(self, document=None):
        """
    ...
    def set_active_tab(self, document):
        pass
...
class EditorTab(GObject.Object):
    ...
    def __init__(self, document=None):
        ...
        if document:
            ...
            name = "Untitled %d" % EditorTab.untitled_counter
        
        # TODO create the complicated tab label widget
        self._tab_widget = Gtk.Label(name)
