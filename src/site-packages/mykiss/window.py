...
class Window(Gtk.Window, LogObject):
    ...
    def add_dock_item(self, label, widget, icon_name=icons.STOCK_PLUGIN, 
        ...
        view_menu = self._ui_manager.get_widget("ui/MainMenu/View/Dock").get_submenu()
        ...
        #menu_item.set_active(item.get_visible())
        menu_item.connect("activate", self._on_view_dock_item_activate, item)
        
        # connect signals to update view menu
        #item.connect("show", self._on_dock_item_show_or_hide, menu_item)
        #item.connect("hide", self._on_dock_item_show_or_hide, menu_item)
    ...
    """
    def _on_dock_item_show_or_hide(self, dock_item, menu_item):
        print dock_item.get_property("name")
        menu_item.set_active(dock_item.get_visible())    
    """
