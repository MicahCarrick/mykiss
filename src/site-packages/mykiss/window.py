...
class Window(Gtk.Window, LogObject):
    ...
    Args:
        application: The Application object instantiating the window.
    """    
    ...
    def _init_dock(self):
        ...
        item = Gdl.DockItem.new_with_stock("plugin-manager", "Plugin Manager",
                                           icons.STOCK_PLUGIN,
                                           Gdl.DockItemBehavior.NORMAL)
        item.add(PluginManager(self.application.data_dir, 
                               get_default_plugin_engine()))                                
    ...
    def on_help_about_activate(self, action, data=None):
        ...
        dialog.set_copyright("Copyright © 2011, Micah Carrick")
        ...
        dialog.set_comments(_("A GTK+ based text editor and integrated development environment."))
        dialog.run()
        dialog.destroy()
