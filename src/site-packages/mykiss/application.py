...
class Application(Gtk.Application, LogObject):
    ...
    def _get_config_file(self, conf_file):
        """
        Return the full path to a configuration file based on XDG specification.
    ...
    def _init_config(self):
        ...
        full_path = self._get_config_file(conf_file)
        self._config.read(full_path)
    ...
    def _on_startup(self, data=None):
        ...
        icons.register_stock_icons(os.path.join(self._data_dir, 'icons', 'hicolor'), 
                                   icons.stock_icons)
        self._init_config()
