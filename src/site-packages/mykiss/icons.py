...
def first_available_icon_name(icons, default):
    """
    Given a list of icon names, returns the first name that exists in the theme
    or returns default if none are found. Usefull with a gio.Icon.get_names()
    """
